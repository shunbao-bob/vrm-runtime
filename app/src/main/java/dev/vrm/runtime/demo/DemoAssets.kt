...
object DemoAssets {
    ...
    /** Bundled VRM 1.0 models copied from xlunar's public/1.0/{models,avatars}. */
    val models = listOf(
        ModelPreset("constraint", "Constraint_Twist", "avatars/VRM1_Constraint_Twist_Sample.vrm"),
        ModelPreset("seed", "Seed-san", "avatars/Seed-san.vrm"),
        ModelPreset("orion", "Avatar Orion", "avatars/Avatar_Orion.vrm"),
        ModelPreset("cryptovoxels", "Cryptovoxels", "avatars/cryptovoxels.vrm"),
        ...
        ModelPreset("aisa", "Aisa", "models/Aisa.vrm"),
        ModelPreset("ayasa", "Ayasa", "models/Ayasa.vrm"),
        ModelPreset("eru", "Eru", "models/Eru.vrm"),
        ModelPreset("hagumi", "Hagumi", "models/Hagumi.vrm"),
        ModelPreset("hinari", "Hinari", "models/Hinari.vrm"),
        ModelPreset("hinase", "Hinase", "models/Hinase.vrm"),
        ModelPreset("irori", "Irori", "models/Irori.vrm"),
        ModelPreset("kanade", "Kanade", "models/Kanade.vrm"),
        ModelPreset("kanami", "Kanami", "models/Kanami.vrm"),
        ModelPreset("kirina", "Kirina", "models/Kirina.vrm"),
        ModelPreset("kizuna", "Kizuna", "models/Kizuna.vrm"),
        ModelPreset("konon", "Konon", "models/Konon.vrm"),
        ModelPreset("meimi", "Meimi", "models/Meimi.vrm"),
        ModelPreset("memi", "Memi", "models/Memi.vrm"),
        ModelPreset("miyuka", "Miyuka", "models/Miyuka.vrm"),
        ModelPreset("momoa", "Momoa", "models/Momoa.vrm"),
        ModelPreset("moyu", "Moyu", "models/Moyu.vrm"),
        ModelPreset("noan", "Noan", "models/Noan.vrm"),
        ModelPreset("nona", "Nona", "models/Nona.vrm"),
        ModelPreset("rena", "Rena", "models/Rena.vrm"),
        ModelPreset("rii", "Rii", "models/Rii.vrm"),
        ModelPreset("rii-uniform", "Rii Uniform", "models/Rii_Uniform.vrm"),
        ModelPreset("rise", "Rise", "models/Rise.vrm"),
        ModelPreset("rizu", "Rizu", "models/Rizu.vrm"),
        ModelPreset("ruika", "Ruika", "models/Ruika.vrm"),
        ModelPreset("saori", "Saori", "models/Saori.vrm"),
        ModelPreset("uina", "Uina", "models/Uina.vrm"),
        ModelPreset("yuduki", "Yuduki", "models/Yuduki.vrm"),
        ModelPreset("yue", "Yue", "models/Yue.vrm"),
        ModelPreset("yukako", "Yukako", "models/Yukako.vrm"),
        ModelPreset("yukana", "Yukana", "models/Yukana.vrm"),
        ModelPreset("yukina", "Yukina", "models/Yukina.vrm"),
        ModelPreset("yumeka", "Yumeka", "models/Yumeka.vrm"),
        ModelPreset("yuyu", "Yuyu", "models/Yuyu.vrm"),
    )
